...
def format_phone(parsed_number):
    ...
    if country_code == '1':  # USA
        return f"+{formatted_number[:1]} {formatted_number[1:4]} {formatted_number[4:7]} {formatted_number[7:]} {formatted_number[7:]}"
        ...
        return f"+{formatted_number[:2]} {formatted_number[2:5]} {formatted_number[5:]}"

    # Handle other country codes with a default format
    if len(formatted_number) > 2:
        return f"+{formatted_number[:2]} {formatted_number[2:5]} {formatted_number[5:]}"  # Default formatting
